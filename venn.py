...
def venn3(labels, names=['A', 'B', 'C'], **options):
    ...
    dpi = options.get('dpi', 96)
    fontsize = options.get('fontsize', 17)
...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    draw_text(fig, ax, 0.84, 0.43, labels.get('00110', ''), fontsize=fontsize)
    ...
    draw_text(fig, ax, 0.39, 0.18, labels.get('01001', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.42, 0.80, labels.get('01010', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.50, 0.15, labels.get('01011', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.70, 0.76, labels.get('01100', ''), fontsize=fontsize)
    ...
    draw_text(fig, ax, 0.76, 0.28, labels.get('10010', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.65, 0.25, labels.get('10011', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.18, 0.50, labels.get('10100', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.21, 0.36, labels.get('10101', ''), fontsize=fontsize)
    ...
    draw_text(fig, ax, 0.27, 0.67, labels.get('11000', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.34, 0.25, labels.get('11001', ''), fontsize=fontsize)
    draw_text(fig, ax, 0.31, 0.72, labels.get('11010', ''), fontsize=fontsize)
    ...
    draw_text(fig, ax, 0.36, 0.64, labels.get('11110', ''), fontsize=fontsize)
