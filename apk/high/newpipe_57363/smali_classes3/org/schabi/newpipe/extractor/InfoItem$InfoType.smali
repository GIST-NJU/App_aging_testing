...
.method static constructor <clinit>()V
    ...
    .line 77
    new-instance v1, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    const-string v3, "PLAYLIST"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;->PLAYLIST:Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    .line 78
    new-instance v3, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    const-string v5, "CHANNEL"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;->CHANNEL:Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    .line 79
    new-instance v5, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    const-string v7, "COMMENT"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;->COMMENT:Lorg/schabi/newpipe/extractor/InfoItem$InfoType;

    const/4 v7, 0x4

    .line 75
    new-array v7, v7, [Lorg/schabi/newpipe/extractor/InfoItem$InfoType;
    ...
    sput-object v7, Lorg/schabi/newpipe/extractor/InfoItem$InfoType;->$VALUES:[Lorg/schabi/newpipe/extractor/InfoItem$InfoType;
