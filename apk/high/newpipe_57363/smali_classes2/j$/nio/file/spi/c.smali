...
.method public final synthetic copy(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    ...
    invoke-static {p2}, Lj$/nio/file/t;->m(Ljava/nio/file/Path;)Lj$/nio/file/Path;
...
.method public final synthetic createDirectory(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)V
    ...
    invoke-static {p2}, Lj$/com/android/tools/r8/a;->f([Ljava/nio/file/attribute/FileAttribute;)[Lj$/nio/file/attribute/FileAttribute;
...
.method public final synthetic createSymbolicLink(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)V
    ...
    invoke-static {p3}, Lj$/com/android/tools/r8/a;->f([Ljava/nio/file/attribute/FileAttribute;)[Lj$/nio/file/attribute/FileAttribute;
...
.method public final synthetic getFileAttributeView(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    ...
    invoke-static {p3}, Lj$/nio/file/l;->k([Ljava/nio/file/LinkOption;)[Lj$/nio/file/LinkOption;
...
.method public final synthetic getFileSystem(Ljava/net/URI;)Ljava/nio/file/FileSystem;
    ...
    invoke-static {p1}, Lj$/nio/file/h;->n(Lj$/nio/file/i;)Ljava/nio/file/FileSystem;
...
.method public final synthetic isHidden(Ljava/nio/file/Path;)Z
    ...
    invoke-virtual {v0, p1}, Lj$/nio/file/spi/d;->n(Lj$/nio/file/Path;)Z
...
.method public final synthetic isSameFile(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lj$/nio/file/spi/d;->o(Lj$/nio/file/Path;Lj$/nio/file/Path;)Z
...
.method public final synthetic move(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    ...
    .line 0
    :goto_1
    invoke-virtual {v0, p1, p2, p3}, Lj$/nio/file/spi/d;->p(Lj$/nio/file/Path;Lj$/nio/file/Path;[Lj$/nio/file/d;)V
...
.method public final synthetic newAsynchronousFileChannel(Ljava/nio/file/Path;Ljava/util/Set;Ljava/util/concurrent/ExecutorService;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/AsynchronousFileChannel;
    ...
    invoke-static {p4}, Lj$/com/android/tools/r8/a;->f([Ljava/nio/file/attribute/FileAttribute;)[Lj$/nio/file/attribute/FileAttribute;

    move-result-object p4

    invoke-virtual {v0, p1, p2, p3, p4}, Lj$/nio/file/spi/d;->q(Lj$/nio/file/Path;Ljava/util/Set;Ljava/util/concurrent/ExecutorService;[Lj$/nio/file/attribute/FileAttribute;)Lj$/nio/channels/a;
...
.method public final synthetic newByteChannel(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/nio/file/spi/d;->r(Lj$/nio/file/Path;Ljava/util/Set;[Lj$/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;
...
.method public final newDirectoryStream(Ljava/nio/file/Path;Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;
    ...
    .line 0
    invoke-virtual {v0, p1, v1}, Lj$/nio/file/spi/d;->s(Lj$/nio/file/Path;Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;
...
.method public final synthetic newFileChannel(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/FileChannel;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/nio/file/spi/d;->t(Lj$/nio/file/Path;Ljava/util/Set;[Lj$/nio/file/attribute/FileAttribute;)Ljava/nio/channels/FileChannel;
...
.method public final synthetic newFileSystem(Ljava/net/URI;Ljava/util/Map;)Ljava/nio/file/FileSystem;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/nio/file/spi/d;->v(Ljava/net/URI;Ljava/util/Map;)Lj$/nio/file/i;
...
.method public final synthetic newFileSystem(Ljava/nio/file/Path;Ljava/util/Map;)Ljava/nio/file/FileSystem;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/nio/file/spi/d;->u(Lj$/nio/file/Path;Ljava/util/Map;)Lj$/nio/file/i;
...
.method public final synthetic newInputStream(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;
    ...
    invoke-static {v4}, Lj$/nio/file/p;->a(Ljava/nio/file/OpenOption;)Lj$/nio/file/r;
    ...
    .line 0
    :goto_1
    invoke-virtual {v0, p1, p2}, Lj$/nio/file/spi/d;->w(Lj$/nio/file/Path;[Lj$/nio/file/r;)Ljava/io/InputStream;
...
.method public final synthetic newOutputStream(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/OutputStream;
    ...
    .line 0
    :goto_1
    invoke-virtual {v0, p1, p2}, Lj$/nio/file/spi/d;->x(Lj$/nio/file/Path;[Lj$/nio/file/r;)Ljava/io/OutputStream;
...
.method public final synthetic readAttributes(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/nio/file/spi/d;->y(Lj$/nio/file/Path;Ljava/lang/Class;[Lj$/nio/file/LinkOption;)Lj$/nio/file/attribute/g;
...
.method public final synthetic readAttributes(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/nio/file/spi/d;->z(Lj$/nio/file/Path;Ljava/lang/String;[Lj$/nio/file/LinkOption;)Ljava/util/Map;
...
.method public final synthetic readSymbolicLink(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-virtual {v0, p1}, Lj$/nio/file/spi/d;->A(Lj$/nio/file/Path;)Lj$/nio/file/Path;
...
.method public final synthetic setAttribute(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)V
    ...
    invoke-static {p4}, Lj$/nio/file/l;->k([Ljava/nio/file/LinkOption;)[Lj$/nio/file/LinkOption;

    move-result-object p4

    invoke-virtual {v0, p1, p2, p3, p4}, Lj$/nio/file/spi/d;->B(Lj$/nio/file/Path;Ljava/lang/String;Ljava/lang/Object;[Lj$/nio/file/LinkOption;)V
