...
.method public static Z(Lj$/time/temporal/TemporalAccessor;)Lj$/time/OffsetDateTime;
    .locals 5
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lj$/time/ZoneOffset;->h0(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZoneOffset;
    ...
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->E(Lj$/time/temporal/s;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lj$/time/temporal/TemporalAccessor;->E(Lj$/time/temporal/s;)Ljava/lang/Object;
    ...
    .line 365
    :cond_1
    invoke-static {p0}, Lj$/time/Instant;->a0(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
...
.method public static a0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    .locals 1
...
.method static c0(Ljava/io/ObjectInput;)Lj$/time/OffsetDateTime;
    .locals 3
...
.method private e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    .locals 1
...
.method public static ofInstant(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/OffsetDateTime;
    ...
    invoke-static {v0, v1, p0, p1}, Lj$/time/LocalDateTime;->n0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public final E(Lj$/time/temporal/s;)Ljava/lang/Object;
    ...
    .line 728
    invoke-virtual {v1}, Lj$/time/LocalDateTime;->u0()Lj$/time/LocalDate;
...
.method public final G(Lj$/time/temporal/l;)Lj$/time/temporal/l;
    ...
    invoke-interface {p1, v2, v3, v0}, Lj$/time/temporal/l;->d(JLj$/time/temporal/r;)Lj$/time/temporal/l;
    ...
    invoke-virtual {v1}, Lj$/time/ZoneOffset;->i0()I
...
.method public final b0(JLj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/LocalDateTime;->o0(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDateTime;

    move-result-object p1

    iget-object p2, p0, Lj$/time/OffsetDateTime;->b:Lj$/time/ZoneOffset;

    invoke-direct {p0, p1, p2}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public compareTo(Lj$/time/OffsetDateTime;)I
    ...
    .line 175
    invoke-virtual {v1, v2}, Lj$/time/LocalDateTime;->K(Lj$/time/chrono/e;)I
    ...
    .line 179
    invoke-virtual {p1}, Lj$/time/i;->f0()I

    move-result p1

    .line 823
    invoke-virtual {v2}, Lj$/time/LocalDateTime;->b()Lj$/time/i;
...
.method public final d(JLj$/time/temporal/r;)Lj$/time/temporal/l;
    ...
    .line 976
    invoke-virtual {v4, p1, p2, p3}, Lj$/time/LocalDateTime;->w0(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;

    move-result-object p1

    invoke-direct {p0, p1, v3}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    invoke-direct {p0, v4, p1}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    .line 859
    :cond_1
    invoke-virtual {v4}, Lj$/time/LocalDateTime;->f0()I
    ...
    .line 971
    invoke-static {p1, p2, v0, v1}, Lj$/time/Instant;->d0(JJ)Lj$/time/Instant;
...
.method public final d0()Lj$/time/LocalDateTime;
    .locals 1
...
.method public final bridge synthetic e(JLj$/time/temporal/TemporalUnit;)Lj$/time/temporal/l;
    ...
    .line 128
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/OffsetDateTime;->b0(JLj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
...
.method public minus(JLj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/OffsetDateTime;->b0(JLj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
...
.method public minusDays(J)Lj$/time/OffsetDateTime;
    ...
    .line 1279
    invoke-virtual {v3, p1, p2}, Lj$/time/LocalDateTime;->p0(J)Lj$/time/LocalDateTime;

    move-result-object p1

    invoke-direct {p0, p1, v2}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/LocalDateTime;->p0(J)Lj$/time/LocalDateTime;

    move-result-object p2

    iget-object v0, p1, Lj$/time/OffsetDateTime;->b:Lj$/time/ZoneOffset;

    invoke-direct {p1, p2, v0}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public minusSeconds(J)Lj$/time/OffsetDateTime;
    ...
    .line 1318
    invoke-virtual {v3, p1, p2}, Lj$/time/LocalDateTime;->r0(J)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/LocalDateTime;->r0(J)Lj$/time/LocalDateTime;
...
.method public minusYears(J)Lj$/time/OffsetDateTime;
    ...
    .line 1217
    invoke-virtual {v3, p1, p2}, Lj$/time/LocalDateTime;->t0(J)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/LocalDateTime;->t0(J)Lj$/time/LocalDateTime;
...
.method public final t(Lj$/time/LocalDate;)Lj$/time/temporal/l;
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->x0(Lj$/time/LocalDate;)Lj$/time/LocalDateTime;

    move-result-object p1

    iget-object v0, p0, Lj$/time/OffsetDateTime;->b:Lj$/time/ZoneOffset;

    invoke-direct {p0, p1, v0}, Lj$/time/OffsetDateTime;->e0(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public truncatedTo(Lj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->v0(Lj$/time/temporal/TemporalUnit;)Lj$/time/LocalDateTime;
...
.method public withOffsetSameInstant(Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0}, Lj$/time/ZoneOffset;->i0()I
